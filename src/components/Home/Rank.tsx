  ...
  return (
    <section className="bg-[#f0efeb] rounded-md relative flex flex-col min-h-[60vh] justify-center items-center p-8">
      <div className="mb-10 flex flex-col gap-2 items-center w-3/4">
        <h1 className="font-mono text-4xl">Our Best Player</h1>
        <p className="text-md text-center">Honoring the excellence and dedication of our top-performing player who consistently shines on the field and inspires us all with their outstanding skills and sportsmanship</p>
      </div>
