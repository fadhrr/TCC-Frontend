  ...
  return (
    <div className="relative w-0 md:w-1/5 my-8 pt-[80px] md:px-6 px-0 block md:sticky h-[calc(100vh-55px)]">
      ...
      <div className="md:hidden z-50 flex gap-2 items-center absolute md:left-[125%] left-[100%] top-10" style={{ width: "300px" }}>
        ...
        <p className="text-xs inline-block md:hidden">Problem Menu </p>
      </div>

      <div ref={menuRef} className={`md:block z-30 md:visible md:opacity-100 ${showMenu ? 'visibility py-10 duration-300 opacity-100 absolute border-2 border-black rounded-md left-10 top-20 w-40 bg-white' : 'invisible left-[120%] top-[120%] w-0 opacity-0'}`}>
