        ...
        <table className="w-full border-separate border-spacing-y-3 table-auto">
          ...
          <tbody className="text-center">
            {scoreboard.map((item, index) => (
              <tr key={index}>
                <td className="bg-[#4D4D4D] text-white border-y-2 border-s-2 border-black h-10 w-10">{item.no}</td>
                <td className="border-y-2 border-black text-left pl-3">{item.contestant}</td>
                <td className="border-y-2 border-e-2 border-black">{item.total}</td>
